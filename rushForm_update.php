...
include "db.php";
    ...
    if (isset($_POST['update'])) {
        ...
        $query=mysqli_query($con,"UPDATE `rush_form` SET  `car_model`='$car_model',`first_name`='$first_name',`last_name`='$last_name',`phone`='$phone',`email`='$email' ,`addr`='$addr' ,`date_start`='$date_start' ,`date_end`='$date_end' ,`numDays`='$numDays' WHERE `id`='$user_id'");
    ...
    if (isset($_GET['id'])) {
        ...
        $query=mysqli_query($con,"SELECT id, car_model, first_name, last_name, phone, email, addr, date_start, date_end, numDays from rush_form WHERE `id`='$user_id'");
                                    ...
                                    <div class="p-4">
                                        <div class="row">
                                            ...
                                            <div class="input-group col-md-4 col-sm-12 mb-3"> 
                                                ...
                                                <input type="text" id="myInput" name="car_model" class="form-control" value="2021 Toyota Rush"required readonly>
                                            </div>
                                            ...
                                            <div class="cancel pt-1 mb-4">
                                                <a href="rushForm_view.php" class="btn-cancel  btn-lg mt-2 mv-3 ">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
