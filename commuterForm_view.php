...
<head>
    ...
    <title>Commuter Van Records</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="button">
            ...
            <a class="btn  btn-lg mt-2 mb-5" href="commuterForm_create.php" role="button"> <button class="addCustomer"><i class="fa fa-plus"></i> Add Customer</button></a>
        </div>
        ...
        ?>
            <tr>
                ...
                <td><a class="btn btn-success" href="commuterForm_update.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="commuterForm_delete.php?id=<?php echo $row['id']; ?>">Delete</td>
            </tr>                       
