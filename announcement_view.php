...
<head>
    ...
    <title>Annoucement Records</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        <div class="container-fluid">
            <a class="navbar-brand"  href="#">
                <img src="logo.png" alt="" width="70" height="50" class="d-inline-block align-text-top">  Leo's Charter </a>
        </div>
    </nav>
        ...
        <table class="table">
            ...
            if ($query->num_rows > 0) {
                ...
                <tr>
                    ...
                    <td><a class="btn btn-success" href="announcement_update.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="announcement_delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
