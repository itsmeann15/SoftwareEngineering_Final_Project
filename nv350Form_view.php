<?php 
    ...
    $query=mysqli_query($con,"SELECT id, car_model, first_name, last_name, phone, email, addr, date_start, date_end, numDays from nv350_form");
...
<head>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="align: center;"> Nissan NV350 Van Customers Records</h1>
            <div class="button">
          
                <a class="btn  btn-lg mt-2 " href="admin_home.php" role="button"> <button class="home"><i class="fa fa-home"></i> Go back home</button></a>
                <a class="btn  btn-lg mt-2 mb-5" href="nv350Form_create.php" role="button"> <button class="addCustomer"><i class="fa fa-plus"></i> Add Customer</button></a>
            </div>   
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><a class="btn btn-success" href="nv350Form_update.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="nv350Form_delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
