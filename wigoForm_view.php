<?php 
    ...
    $query=mysqli_query($con,"SELECT id, car_model, first_name, last_name, phone, email, addr, date_start, date_end, numDays from wigo_form");
...
<head>
    ...
    <title>Toyota Wigo Records</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1 style="align: center;">Toyota Wigo Hatchback</h1>

            <div class="button">
          
                <a class="btn  btn-lg mt-2 " href="admin_home.php" role="button"> <button class="home"><i class="fa fa-home"></i> Go back home</button></a>
                <a class="btn  btn-lg mt-2 mb-5" href="wigoForm_create.php" role="button"> <button class="addCustomer"><i class="fa fa-plus"></i> Add Customer</button></a>
            ...
            <table class="table">
                ...
                <tbody> 
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-success" href="wigoForm_update.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="wigoForm_delete.php?id=<?php echo $row['id']; ?>">Delete</td>
                    </tr>                       
