...
$conn=mysqli_connect("localhost","u990768367_leorentacar","Therealowner2022","u990768367_leo_db");
    if(isset($_POST['submit'])) {
        ...
        $query1="SELECT car_model, first_name, last_name, phone, email, addr, date_start, date_end, numDays FROM commuter_form where date_start='$date_start'  ";
    ...
    $query=mysqli_query($conn, "INSERT INTO commuter_form (car_model, first_name, last_name, phone, email, addr, date_start, date_end, numDays) values ('$car_model', '$first_name', '$last_name', '$phone', '$email','$addr','$date_start', '$date_end', '$numDays')");
...
<body>
    ...
    <!--COMMUTER FORM FILL UP BY THE CUSTOMERS-->
