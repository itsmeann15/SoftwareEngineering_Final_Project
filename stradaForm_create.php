<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $query1="SELECT car_model, first_name, last_name, phone, email, addr, date_start, date_end, numDays FROM strada_form where date_start='$date_start'  ";
    ...
    $query=mysqli_query($conn, "INSERT INTO strada_form (car_model, first_name, last_name, phone, email, addr, date_start, date_end, numDays) values ('$car_model', '$first_name', '$last_name', '$phone', '$email','$addr','$date_start', '$date_end', '$numDays')");
  ...
  <head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="desc">
                <div class="row mt-2">
                    <b style="text-align: center; font-size: 25px;">2021 Mitsubishi Strada</b>
                    <br>
                                ...
                                <div class="p-4">
                                    <div class="row">
                                        <div class="input-group col-md-4 col-sm-12 mb-3"> 
                                            ...
                                            <input type="text" id="myInput" name="car_model" class="form-control" value="2021 Mitsubishi Strada"required readonly>
                                        </div>
